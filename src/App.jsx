...
export default function Page() {
  ...
  const getNoButtonText = () => {
    const phrases = [
      "Үгүй",
      "За арай ч дээ, охидоо?",
      "Гэртээ хариад яах юм бэ? 😴",
      "Ганцхан орой шүү дээ!",
      "Битгий маяглаад бай л даа!",
      "Маргааш лекцтэй юм уу? 😂",
      "Бие даалтаа маргааш хийчих ээ...",
      "Чи л байхгүй бол сонирхолгүй шүү дээ!",
      "Дараа нь харамсав аа, гоё юм болно шүү!",
      "Ганц л олдох 1-р курс шүү дээ, гарцгаая! 🥂",
      "Гуйж байна шүү дээ, найзууд минь!",
      "Зүгээр л 'Тийм' гээд дарчих аа,  тэгэх үү? ✨",
    ];
  ...
  useEffect(() => {
    if (yesPressed && noCount < 4 && !popupShown) {
      Swal.fire({
        title:
          "Өө манай охид чинь ямар амархан зөвшөөрчихөв өө! 😂 Жаахан 'маяглаж' намайг гүйлгэхгүй юм уу? 🥰✨",
        showClass: {
          popup: `
            animate__animated
            animate__fadeInUp
  ...
  useEffect(() => {
    if (yesPressed && noCount > 3 && !yespopupShown) {
      Swal.fire({
        title:
          "За ингээд л болоо шүү дээ! 🥰 Орой хага авч, дурсамж дүүрэн өнгөрүүлцгээе. Манай охид ч хамгийн тасархай нь шүү! ❤️🔥👯‍♀️",
        width: 800,
        padding: "2em",
        color: "#716add",
        background: `#fff url(${swalbg})`,
  ...
  useEffect(() => {
    if (noCount == 25) {
      Swal.fire({
        title:
          "За за, та нар үнэхээр зөрүүд юм аа! 😂 Гэхдээ бидний нөхөрлөл хэзээ ч 'Үгүй' гэдэг хариултыг хүлээж авахгүй ээ. ❤️ 'Тийм' гэж дараад хамгийн гоё дурсамжаа хамт бүтээцгээе! 🥰✨<br/><br/>'Жинхэнэ охидын нөхөрлөл хэзээ ч бууж өгдөггүй юм шүү!'",
        width: 850,
        padding: "2em",
        color: "#716add",
        background: `#fff url(${swalbg})`,
      ...
      <div className="overflow-hidden flex flex-col items-center justify-center pt-4 h-screen -mt-16 selection:bg-rose-600 selection:text-white text-zinc-900">
        {yesPressed && noCount > 3 ? (
          <>
            ...
            >
              Пөөх, шууд зөвшөөрчихлөө гэж үү! 😍
            </div>
            <div
            ...
            >
              {" "}
              Тэгвэл орой уулзацгаая, байршлаа групп дээрээ ярилцъя!.{" "}
            </div>
            <WordMareque />
          </>
        ) : (
          <>
            ...
            <h1 className="text-4xl md:text-6xl my-4 text-center px-4">
              За залуусаа, өнөөдөр орой хамт гарах уу? 🍻✨
            </h1>
